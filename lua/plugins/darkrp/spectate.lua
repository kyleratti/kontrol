...
if( SERVER ) then
	...
	kontrol:AddCommand( "spectate", function( objPl, sCmd, tArgs )
		...
		if( !kontrol:ValidCommand( objPl, objTarget ) ) then return; end
		...
		if( GAMEMODE:IsDarkRP( ) ) then
			...
			elseif( objPl.ASS_Spec ) then
				...
				timer.Simple( .1, function( )
					...
					objPl:SelectWeapon( objPl.ASS_Spec.SelectedWeapon || objPl:GetInfo( "cl_defaultweapon" ) || "keys" );
					objPl.ASS_Spec = nil;
